...
export function AEFT_getProjectDir() {
  try {
...
export function AEFT_diagInOut() {
  try {
...
export function AEFT_showFileDialog(payloadJson) {
  try {
...
export function AEFT_exportInOutVideo(payloadJson) {
  try {
    var p = {}; try { p = JSON.parse(payloadJson || '{}'); } catch (e) {}
...
export function AEFT_exportInOutAudio(payloadJson) {
  try {
    var p = {}; try { p = JSON.parse(payloadJson || '{}'); } catch (e) {}
...
export function AEFT_insertAtPlayhead(jobId) {
  try {
    var extPath = _extensionRoot();
...
export function AEFT_insertFileAtPlayhead(payloadOrJson) {
  try {
    var p = {};
    var path = '';
    try {
...
export function AEFT_revealFile(payloadJson) {
  try {
    var p = {}; try { p = JSON.parse(payloadJson || '{}'); } catch (e) {}
...
export function AEFT_ensureDir(dirPath) {
  try {
...
export function AEFT_fileExists(filePath) {
  try {
...
export function AEFT_readThumbnail(filePath) {
  try {
    var file = new File(filePath);
    if (!file.exists) {
...
export function AEFT_saveThumbnail(payload) {
  try {
